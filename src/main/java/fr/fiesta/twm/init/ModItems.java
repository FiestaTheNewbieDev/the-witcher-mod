...
public class ModItems {
    ...
    public static final RegistryObject<Item> RAW_METEORITE = ITEMS.register("raw_meteorite", ()-> new Item(new Item.Properties().group(ModItemGroups.TWM_TAB)));
    public static final RegistryObject<Item> METEORITE_INGOT = ITEMS.register("meteorite_ingot", ()-> new Item(new Item.Properties().group(ModItemGroups.TWM_TAB)));

    public static final RegistryObject<Item> METEORITE_SILVER_INGOT = ITEMS.register("meteorite_silver_ingot", ()-> new Item(new Item.Properties().group(ModItemGroups.TWM_TAB)));
    ...
    public static final RegistryObject<BlockItem> METEORITE_ORE = ITEMS.register("meteorite_ore_item", ()-> new BlockItem(ModBlocks.METEORITE_ORE.get(), new Item.Properties().group(ModItemGroups.TWM_TAB)));
}
